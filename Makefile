...
UNREALROOTPATH = "/home/sir/Aktywatory/UnrealEngine"
GAMEPROJECTFILE =/home/sir/Dokumenty/Unreal Projects/PopielTower/PopielTower.uproject
...
TARGETS = \
	...
	PopielTower-Linux-Debug  \
	PopielTower-Linux-DebugGame  \
	PopielTower-Linux-Shipping  \
	PopielTower-Linux-Test  \
	PopielTower \
	PopielTowerEditor-Linux-Debug  \
	PopielTowerEditor-Linux-DebugGame  \
	PopielTowerEditor-Linux-Shipping  \
	PopielTowerEditor-Linux-Test  \
	PopielTowerEditor\
	configure
...
PopielTower-Linux-Debug:
	 $(PROJECTBUILD) PopielTower Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTower-Linux-DebugGame:
	 $(PROJECTBUILD) PopielTower Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTower-Linux-Shipping:
	 $(PROJECTBUILD) PopielTower Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTower-Linux-Test:
	 $(PROJECTBUILD) PopielTower Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTower:
	 $(PROJECTBUILD) PopielTower Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTowerEditor-Linux-Debug:
	 $(PROJECTBUILD) PopielTowerEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTowerEditor-Linux-DebugGame:
	 $(PROJECTBUILD) PopielTowerEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTowerEditor-Linux-Shipping:
	 $(PROJECTBUILD) PopielTowerEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTowerEditor-Linux-Test:
	 $(PROJECTBUILD) PopielTowerEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

PopielTowerEditor:
	 $(PROJECTBUILD) PopielTowerEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
